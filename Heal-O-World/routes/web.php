...
require base_path('routes/patient-office.php');
require base_path('routes/doctor-office.php');
require base_path('routes/doctor-consultation.php');
require base_path('routes/patient-consultation.php');
