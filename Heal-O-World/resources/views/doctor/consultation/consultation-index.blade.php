...
<form method="GET" class="filter-form">
    ...
    <select name="sort" id="sort" onchange="this.form.submit()">
        <option value="desc" {{ request('sort') == 'desc' ? 'selected' : '' }}>Новіші</option>
        <option value="asc" {{ request('sort') == 'asc' ? 'selected' : '' }}>Старіші</option>
    </select>
</form>
    ...
    @forelse($consultations as $consultation)
        <li class="consultation-card">
            <div class="card-content">
                ...
                <p><strong>Пацієнт:</strong> {{ $consultation->patient->first_name ?? 'Немає' }} {{ $consultation->patient->last_name ?? '' }}</p>
